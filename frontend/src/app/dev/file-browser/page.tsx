 ...
 *   2. DocTabsBar    — three open tabs, active/inactive styling, toggle + upload
  ...
  return (
    <div className="min-h-screen bg-background p-6 text-sm">
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        {/* ================================================================ */}
        <Section title="1 — DocTabsBar (3 tabs, toggleable browser, upload button)">
          ...
          <p className="text-xs text-muted-foreground">
            Click tabs to activate · × to close · grid icon toggles browser · ↑ icon opens upload
          </p>
        </Section>
